...
class TheHiveActions(AppBase):
    ...
    def delete_task_log(self, log_id, url, apikey):
        url = url + "/api/case/task/log/" + str(log_id)
        headers = {
            "Authorization": "Bearer " + str(apikey)
        }
        try:
    ...
    def update_task_log(self, log_id, message, url, apikey):
        url = url + "/api/case/task/log/" + str(log_id)
        headers = {
            "Authorization": "Bearer " + str(apikey)
        }
    ...
    def update_case_task(self, task_id, status, url, apikey):
        url = url + "/api/case/task/" + str(task_id)
        headers = {
            "Authorization": "Bearer " + str(apikey)
        }
        payload = {
